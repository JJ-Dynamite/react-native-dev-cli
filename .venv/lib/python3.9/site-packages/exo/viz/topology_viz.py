...
class TopologyViz:
  def __init__(self, chatgpt_api_endpoints: List[str] = [], web_chat_urls: List[str] = []):
    ...
    self.main_panel = Panel(self._generate_main_layout(), title="Valen Nodes (0 nodes)", border_style="bright_yellow")
  ...
  def refresh(self):
    ...
    self.main_panel.title = f"Valen Nodes ({node_count} node{'s' if node_count != 1 else ''})"
